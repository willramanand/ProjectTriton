...
public class Character {
	...
	public void setName(String newName) { name = newName.substring(0, 1).toUpperCase() + newName.substring(1); }
	public String getName() { return name; }
	
	// All Health methods for getting and setting current and max health
	public void setCurrentHealth(double newCurrentHealth) { currentHealth = newCurrentHealth; }
